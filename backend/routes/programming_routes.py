...
class CodeAnalysisRequest(BaseModel):
    ...
    language: str = Field(
        default="python",
        description="编程语言 (python, javascript, java, c++, rust, go, sql)",
    )
...
class CodeGenerationRequest(BaseModel):
    ...
    code_type: str = Field(
        default="function", description="代码类型 (function, class, algorithm, test)"
    )
...
async def analyze_code(
    ...
    try:
        ...
        analysis_result = manager.programming_manager.analyze_code(
            code=request.code, language=language_enum
        )
...
async def generate_code(
    ...
    try:
        ...
        return CodeGenerationResponse(
            ...
            analysis_result=(
                result["analysis_result"] if request.include_analysis else None
            ),
