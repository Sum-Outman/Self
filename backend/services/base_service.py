...
class BaseService(ABC, Generic[T]):
    ...
    def _register_with_registry(self) -> bool:
        ...
        if (
            ...
            or self.__class__.__name__ == "ServiceRegistry"
        ):
            self.logger.debug("服务注册中心自身跳过注册")
            return True
            ...
            def wrapper(*args, **kwargs):
                ...
                for attempt in range(max_retries + 1):
                    try:
                        ...
                        # 更新指标
                        service_instance.update_metrics(
                            operation_name, True, response_time
                        )
                        ...
                        service_instance.update_metrics(
                            operation_name, False, response_time
                        )
