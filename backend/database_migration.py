...
def import_all_models():
    ...
    from db_models.user import (
        ...
        LoginAttempt, TwoFactorTempSession, EmailTwoFactorCode
    )
    
    # AGI相关模型
    from db_models.agi import AGIModel, TrainingJob
    
    # 记忆相关模型
    from db_models.memory import Memory, MemoryAssociation
    
    # 知识库相关模型
    from db_models.knowledge import KnowledgeItem, KnowledgeSearchHistory
    ...
    # 机器人相关模型
    from db_models.robot import Robot, RobotJoint, RobotSensor
    
    # 机器人市场相关模型
    from db_models.robot_market import (
        RobotMarketListing, RobotMarketRating, RobotMarketComment,
        RobotMarketDownload, RobotMarketFavorite
    )
