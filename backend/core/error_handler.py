...
class ErrorHandler:
    ...
    def _handle_general_exception(self, exception: Exception, context: Dict[str, Any]) -> Dict[str, Any]:
        """处理一般异常"""
        ...
        return {
            ...
            'error': {
                ...
                'type': 'internal_error',
                'message': '内部服务器错误',
                'details': str(exception) if self._should_show_details(context) else None,
                'operation': operation,
            },
            'timestamp': context.get('timestamp'),
        }
    
    def _handle_http_exception(self, exception: HTTPException, context: Dict[str, Any]) -> Dict[str, Any]:
        """处理HTTP异常"""
    ...
    def _handle_type_error(self, exception: TypeError, context: Dict[str, Any]) -> Dict[str, Any]:
        """处理类型错误"""
    ...
    def _handle_attribute_error(self, exception: AttributeError, context: Dict[str, Any]) -> Dict[str, Any]:
        """处理属性错误"""
    ...
    def _minimal_error_response(self, exception: Exception, context: Dict[str, Any]) -> Dict[str, Any]:
        """最小化错误响应（处理器失败时的后备）"""
    ...
    if func is None:
        ...
        def decorator(f: F) -> F:
            ...
            async def wrapper(*args, **kwargs):
                try:
                    return await f(*args, **kwargs) if callable(f) else f(*args, **kwargs)
