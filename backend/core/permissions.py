...
class PermissionManager:
    ...
    def check_permission(
        user: User, permission: Permission, db: Session = None
    ) -> bool:
        """检查用户是否具有指定权限"""
...
require_user_manage_roles = PermissionManager.require_permission(
...
require_knowledge_upload = PermissionManager.require_permission(
    Permission.KNOWLEDGE_UPLOAD
)
require_knowledge_update = PermissionManager.require_permission(
    Permission.KNOWLEDGE_UPDATE
)
require_knowledge_delete = PermissionManager.require_permission(
    Permission.KNOWLEDGE_DELETE
)
require_knowledge_search = PermissionManager.require_permission(
...
require_training_delete = PermissionManager.require_permission(
...
require_market_download = PermissionManager.require_permission(
