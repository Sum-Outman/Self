...
class ResponseCache:
    ...
    def __init__(self, ttl: int = 300, cache_level: CacheLevel = CacheLevel.MEMORY, 
...
# 带监控的缓存装饰器
def monitored_cache_response(ttl: int = 300, cache_level: CacheLevel = CacheLevel.MEMORY):
    """
    带监控的响应缓存装饰器
