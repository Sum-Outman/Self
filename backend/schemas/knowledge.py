...
class KnowledgeItemBase(BaseModel):
    ...
    type: str = Field("document", description="类型: text, image, video, audio, document, code, dataset")
...
class KnowledgeSearchRequest(BaseModel):
    ...
    sort_by: str = Field("relevance", description="排序字段: relevance, date, access, size")
