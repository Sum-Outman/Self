...
class SpatialReasoningEngine:
    ...
    def _calculate_angle(self, vector1: Tuple[float, float], vector2: Tuple[float, float]) -> float:
        """计算两向量间夹角 - 余弦公式"""
    ...
    def _detect_collision(self, shape1: Tuple[float, float, float, float], shape2: Tuple[float, float, float, float]) -> bool:
        """检测形状碰撞 - 简化的轴对齐边界框检测"""
    ...
    def _check_containment(self, point: Tuple[float, float], shape: Tuple[float, float, float, float]) -> bool:
        """检查点是否在形状内 - 简化的矩形包含检测"""
    ...
    def calculate_angle_between_vectors(self, vector1: Tuple[float, float], vector2: Tuple[float, float]) -> float:
        """计算两向量间夹角（公开方法）"""
        return self._calculate_angle(vector1, vector2)
    
    def detect_collision(self, shape1: Tuple[float, float, float, float], shape2: Tuple[float, float, float, float]) -> bool:
        """检测形状碰撞（公开方法）"""
        return self._detect_collision(shape1, shape2)
    
    def check_point_containment(self, point: Tuple[float, float], shape: Tuple[float, float, float, float]) -> bool:
        """检查点是否在形状内（公开方法）"""
