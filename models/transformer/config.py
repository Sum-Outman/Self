...
class ModelConfig(AGIModelConfig):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        agi_fields = {
            ...
            'initializer_range', 'layer_norm_eps', 'multimodal_enabled',
            'text_embedding_dim', 'image_embedding_dim', 'audio_embedding_dim',
            'video_embedding_dim', 'sensor_embedding_dim', 'fused_embedding_dim',
            'planning_enabled', 'reasoning_enabled', 'execution_control_enabled',
            'self_cognition_enabled', 'learning_enabled', 'self_correction_enabled',
            'multimodal_fusion_enabled', 'learning_rate', 'weight_decay',
